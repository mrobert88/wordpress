...
if (!function_exists('jaxlite_scripts_styles')) {
	...
	function jaxlite_scripts_styles() {
		...
		wp_enqueue_script('jax-lite-html5shiv', get_template_directory_uri().'/assets/scripts/html5shiv.js', FALSE, '3.7.3');
		wp_script_add_data('jax-lite-html5shiv', 'conditional', 'IE 8' );
		
		wp_enqueue_script('jax-lite-selectivizr', get_template_directory_uri().'/assets/scripts/selectivizr.js', FALSE, '1.0.3b');
		wp_script_add_data('jax-lite-selectivizr', 'conditional', 'IE 8' );
	...
	function jaxlite_setup() {
		...
		register_default_headers( array(
			'default-image' => array(
				...
				'description'   => __( 'Default image', 'sveva' )
			),
		));
